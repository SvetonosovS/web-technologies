...
const temperC = Number.parseFloat(prompt("Введите температуру в градусах Цельсия:  "));
const temperF = transformInF(temperC);
alert(`Цельсий: ${temperC}, Фаренгейт: ${temperF}`);

function transformInF(Num) {
    return Math.round(((9 / 5) * Num + 32) * 100) / 100;
}