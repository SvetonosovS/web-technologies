...
$work = [
    [
        ...
        "description" => "описание работы директора",
    ],
    [
        "name" => "Начальник",
        "dataStart" => "Апрель 2015",
        "dataEnd" => "Май 2018",
        "description" => "описание работы начальника",
    ],
    [
        "name" => "Рабочий",
        "dataStart" => "Май 2010",
        "dataEnd" => "Апрель 2015",
        "description" => "описание работы рабочего",
    ],
];
?>
<!DOCTYPE html>
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
       ...
       <?php for($i = 0; $i < count($work); $i++): ?>
            <div class="w3-container">
                ...
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$work[$i]['dataStart']; ?> - 
                    <?php if ($i == 0): ?>
                    <span class="w3-tag w3-teal w3-round"><?=$work[$i]['dataEnd']; ?></span>
                    <?php else: ?>
                        <?=$work[$i]['dataEnd']; ?>
                    <?php endif; ?> 
                </h6>
